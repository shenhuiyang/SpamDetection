...
public class EmailSubject {
    ...
    public static String getHobby(String filePath) {
        String subject = EmailSubject.getSubject(filePath);
    ...
    public static Map<String,String> getHobbyMap() {
        ...
        String[] language = {"python", "java", "perl"};
        String[] os = {"opensuse", "ubuntu", "fedora", "vista", "linux", "unix"};
        String[] data = {"weka", "spark"};
        String[] tech = {"bug", "svn", "mysql", "oracle", "spambeyes", "patch", "python-dev"};
